...
export function TeamHub({
  ...
  const [activeTab, setActiveTab] = useState<"workspace" | "boards">("workspace");
  ...
  return (
    <div className="flex flex-col gap-6 p-6 animate-in fade-in duration-200">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-border pb-5">
        <div>
          ...
          <p className="text-xs text-text-subtle mt-1">
            Manage team members, workspace capacity, and board-wise member role assignments.
          </p>
        </div>
      ...
      <div className="flex items-center gap-2 border-b border-border">
        ...
        >
          <Users size={16} /> Workspace Capacity ({members.length})
        </button>
      ...
      {/* Tab 1: Workspace Members & Capacity */}
      {activeTab === "workspace" && (
        <>
          {/* Top Capacity Stats */}
                  ...
                  <div>
                    ...
                    <div className="mt-4 pt-3 border-t border-border/50">
                      <div className="flex items-center justify-between text-xs mb-1.5">
                        ...
                        <span
                          className={`font-bold ${
                            isOverloaded ? "text-amber-600" : "text-emerald-600"
                          }`}
                        >
