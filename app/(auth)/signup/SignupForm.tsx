      ...
      <div className="rounded-2xl border border-border-strong bg-surface p-7 sm:p-8 shadow-xl relative overflow-hidden">
        ...
        <div className="flex flex-col gap-1.5 mb-6">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-black text-default tracking-tight">Create Workspace</h1>
          ...
          <p className="text-xs text-subtle font-normal">Get started with Trackly for free — no credit card required</p>
        </div>

        <form action={action} className="flex flex-col gap-4">
          {/* Full name */}
          <div className="flex flex-col gap-1.5">
            <label className="text-[11px] font-bold text-subtle uppercase tracking-wider" htmlFor="signup-name">
              Full Name
            </label>
            <input
              id="signup-name"
          ...
          {/* Work email */}
          <div className="flex flex-col gap-1.5">
            <label className="text-[11px] font-bold text-subtle uppercase tracking-wider" htmlFor="signup-email">
              Work Email
            </label>
            <input
              id="signup-email"
          ...
          {/* Password */}
          <div className="flex flex-col gap-1.5">
            <label className="text-[11px] font-bold text-subtle uppercase tracking-wider" htmlFor="signup-password">
              Password
            </label>
          ...
          {/* Workspace name */}
          <div className="flex flex-col gap-1.5">
            <label className="text-[11px] font-bold text-subtle uppercase tracking-wider" htmlFor="signup-site">
              Workspace Name
            </label>
            <input
              id="signup-site"
